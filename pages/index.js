...
export default function Home() {
  return (
    <>
      <Head>
        <title>SleekSite | Build Beautiful</title>
      ...
      <main className="bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] min-h-screen flex items-center justify-center text-white px-6">
        <div className="text-center max-w-3xl animate-fade-in-up">
          ...
          <div className="flex justify-center gap-6">
            <a href="/about" className="bg-pink-500 hover:bg-pink-600 text-white py-3 px-6 rounded-xl text-lg transition shadow-lg">
              Learn More
            </a>
            <a href="/contact" className="border border-pink-400 hover:bg-pink-400 hover:text-white text-pink-300 py-3 px-6 rounded-xl text-lg transition shadow-lg">
              Contact Us
            </a>
          </div>
        </div>
